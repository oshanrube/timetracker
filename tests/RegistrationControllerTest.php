...
class RegistrationControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userRepository = $container->get(LoginRepository::class);
...
//        self::assertEmailCount(1);
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'no-reply@timetracker.com');
        ...
        self::assertTrue(static::getContainer()->get(LoginRepository::class)->findAll()[0]->isVerified());
    }
}
